 ...
 * @endcode
 */
$settings['hash_salt'] = '1rFj_Q7bYOcIks8EvC3FewWKppCIpgy8q8GmtsPMHZUIHQ5u_YGbrjeKQEUzRkF0GjeCmP3t3g';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_d8lightningorg1_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_d8lightningorg1_dev_default.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'lightning_8_veterans',
  'username' => 'drupaluser',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/d8lightningorg1/d8lightningorg1-settings.inc');
}
